...
async function sendText({ botToken, chatId, messageThreadId, text, idempotencyKey, relayUrl = process.env.TELEGRAM_RELAY_URL, fetchImpl = fetch }) {
...
module.exports = { API_ROOT, relaySignature, sendText }
